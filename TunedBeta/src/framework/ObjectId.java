...
public enum ObjectId {
	...
	// Player
	inventory(), critter(), compost1, school, guardian, barrier, gameover, wclock, person, instr3, rope, wood, ptrash, estuary, game3timer, gabion, gamewin, compost2, MiracleTree, tutorial;
