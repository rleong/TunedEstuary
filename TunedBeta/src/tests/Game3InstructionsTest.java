...
public class Game3InstructionsTest {
	Game3Instructions tester = new Game3Instructions(1.0,1.0,ObjectId.instr3,null);
	...
	public void getIdTest() {
		assertEquals(tester.getId(),ObjectId.instr3);
	}
	@Test
